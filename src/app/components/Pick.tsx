...
function Pick() {
  return (
    <div className="bg-gray-100">
      <div>
        <Heading title="EDITORS PICK" paragraph="Problems trying to resolve the conflict between " 
        className="para"/>
      </div>
      ...
      <div className="container mx-auto p-4 max-w-[1050px]">
        ...
        <div className="flex justify-center items-center lg:flex-row flex-col gap-4">
          ...
          <div className="relative  overflow-hidden">
            ...
            <button className="absolute bottom-4 left-4 bg-white text-black1 px-8 py-3  hover:bg-Color hover:text-white transition duration-300">
            MEN
            </button>
          </div>

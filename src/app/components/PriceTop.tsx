  ...
  return (
    <>
      <div className="container mx-auto p-24 max-w-[1050px] flex flex-col items-center justify-center leading-relaxed">
        ...
        {/* Big Heading */}
        <h1 className="text-black lg:text-[58px] text-[40px]  font-black mb-4">
          Simple Pricing
        </h1>
      ...
      <div className="bg-Background text-center">
        ...
        <h1 className="text-black lg:text-[58px] text-[40px]  font-black1 mb-4">Pricing</h1>
      ...
      <div className="flex flex-wrap justify-between items-center container mx-auto p-24 max-w-[1050px] ">
        ...
        <span className="bg-blue-300 text-Color px-8 py-4 rounded-full">Save 25%</span>
        </div>
        <Pricings/>
